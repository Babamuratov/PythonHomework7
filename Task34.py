...
def vowelCounting(words):
    vowels = 'аеёиоуыэюяАЕЁИОУЫЭЮЯ'
    wordsWithVowels = [[letter for letter in word if letter in vowels] for word in words]
    countingWordsWithVowels = [len(vowels) for vowels in wordsWithVowels]
    return all(x == countingWordsWithVowels[0] for x in countingWordsWithVowels)


poem = input('Введите стихотворение: ')
poem_words = poem.split(' ')
if vowelCounting(poem_words):
